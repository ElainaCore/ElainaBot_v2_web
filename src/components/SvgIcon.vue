...
const ICONS = {
  ...
  desktop: '<rect x="3" y="4.5" width="18" height="13" rx="2.5"/><path d="M8.5 21h7M12 17.5V21"/>',
  'eye-off': '<path d="M3 3l18 18"/><path d="M10.6 5.7A9.7 9.7 0 0112 5.5c6 0 9.5 6.5 9.5 6.5a14.3 14.3 0 01-2.1 3"/><path d="M6.2 6.4A15.4 15.4 0 002.5 12s3.5 6.5 9.5 6.5a9.5 9.5 0 004.1-.9"/><path d="M9.9 9.9a3 3 0 004.2 4.2"/>',
  'arrow-forward': '<path d="M5 12h14M14 7l5 5-5 5"/>',
  sparkles: '<path d="M9 3l1.1 3.2L13 7.5l-2.9 1.3L9 12l-1.1-3.2L5 7.5l2.9-1.3zM17.5 12l.9 2.6 2.6.9-2.6.9-.9 2.6-.9-2.6-2.6-.9 2.6-.9z"/><path d="M4.5 15.5l.5 1.3 1.3.5-1.3.5-.5 1.3-.5-1.3-1.3-.5 1.3-.5z" fill="currentColor" stroke="none"/>',
  qq: '<g transform="translate(2.6 1.4) scale(1.55)"><path d="M11.727 6.719c0-.022.01-.375.01-.557 0-3.07-1.45-6.156-5.015-6.156-3.564 0-5.014 3.086-5.014 6.156 0 .182.01.535.01.557l-.72 1.795a25.85 25.85 0 0 0-.534 1.508c-.68 2.187-.46 3.093-.292 3.113.36.044 1.401-1.647 1.401-1.647 0 .979.504 2.256 1.594 3.179-.408.126-.907.319-1.228.556-.29.213-.253.43-.201.518.228.386 3.92.246 4.985.126 1.065.12 4.756.26 4.984-.126.052-.088.088-.305-.2-.518-.322-.237-.822-.43-1.23-.557 1.09-.922 1.594-2.2 1.594-3.178 0 0 1.041 1.69 1.401 1.647.168-.02.388-.926-.292-3.113a25.78 25.78 0 0 0-.534-1.508l-.72-1.795ZM9.773 5.53a.095.095 0 0 1-.014.167c-.65.327-2.104.729-3.055.729h-.008c-.95 0-2.405-.402-3.054-.73a.095.095 0 0 1-.015-.166c.09-.064.183-.13.284-.19.767.44 1.929.746 2.782.746h.008c.853 0 2.015-.307 2.782-.746.1.06.194.126.29.19Z" fill="none" stroke-width="0.97"/></g><path d="M20.8 2.2l.45 1.05 1.05.45-1.05.45-.45 1.05-.45-1.05-1.05-.45 1.05-.45z" fill="currentColor" stroke="none"/><circle cx="2.8" cy="6.5" r=".8" fill="currentColor" stroke="none"/>',
