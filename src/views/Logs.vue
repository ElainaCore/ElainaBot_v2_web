...
const LC_LABELS = { group_add:'机器人入群', group_del:'机器人退群', group_member_add:'用户入群', group_member_del:'用户退群', group_join_request:'入群申请', friend_add:'加好友', friend_del:'删好友', group_msg_reject:'关闭主动消息', group_msg_receive:'开启主动消息', subscribe_status:'订阅开启', subscribe_close:'订阅关闭', MESSAGE_REACTION_ADD:'表态', MESSAGE_REACTION_REMOVE:'取消表态', GUILD_UPDATE:'频道更新' }
function lcTag(e) {
